            ...
            <div id="sidebar-menu" class="sidebar-menu">
                <ul>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            <li>
                                <a href="{{ route('my_profile') }}"><i class="la la-child"></i>&nbsp; <span> My
                                        Profile </span></a>
                            </li>
                            <li>
                                <a href="{{ route('my_attendance') }}"><i class="la  la-calendar"></i> &nbsp;<span> My
                                        Attendance </span></a>
                            </li>
                            <li>
                                <a href="{{ route('my_salary') }}"><i class="la la-inr"></i> &nbsp; <span> My Salary
                                    </span></a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li class="submenu">
                        ...
                        <ul style="display: none;">
                            ...
                            <li><a href="{{ route('roles_group') }}"> <i class="la la-group"></i> &nbsp; <span> Roles
                                        & Group </span></a></li>
                            <li><a href="{{ route('salary_settings') }}"><i class="la la-money"></i> &nbsp; <span>
                                        Salary Settings </span></a></li>
                            <li><a href="{{ route('add_employee') }}"><i class="la la-map-marker"></i> &nbsp; <span>
                                        Add Employees </span></a></li>
