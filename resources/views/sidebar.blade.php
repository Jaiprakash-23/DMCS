                ...
                <div class="sidebar-inner slimscroll">
					<div id="sidebar-menu" class="sidebar-menu">
						<ul>
							...
							<li> 
								<a href="allemploy.php"><i class="la la-users"></i> <span> All Employee </span></a>
							</li>
							<li> 
								<a href="attendance.php"><i class="la la-file-powerpoint-o"> </i> &nbsp; <span> All Employee Attendance </span></a></li>

							<li><a href="allemp_salary.php"> <i class="la la-money"></i> &nbsp; <span> Employee Salary Report </span></a></li>
							<li>
								<a href="sitename-salary.php"><i class="la la-child"></i>&nbsp; <span> Site Name & salary  </span></a>
								</li>
                              ...
                              <li class="submenu">
								...
								<ul style="display: none;">							
							<li>
								<a href="my_profile.php"><i class="la la-child"></i>&nbsp; <span> My Profile  </span></a>
								</li>
							<li> 
								<a href="my-attendance.php"><i class="la  la-calendar"></i> &nbsp;<span> My Attendance </span></a>
							</li>
							<li> 
								<a href="#"><i class="la la-inr"></i> &nbsp; <span> My Salary </span></a> 
							</li>
							</ul>
							</li>
							...
							<li class="submenu">
								...
								<ul style="display: none;">
									<li>
									<a href="all_employ-attendance.php"><i class="la  la-calendar"></i> &nbsp; <span> All Employees </span></a>
									</li>
									<li>
									<a href="attendance_guard.php"><i class="la la-calendar"></i> &nbsp; <span> Guard </span></a>
									</li>
									<li>
									<a href="attendance_qrt.php"><i class="la la-calendar"></i> &nbsp; <span> QRT </span></a>
									</li>
									<li>
									<a href="attendance_officer.php"><i class="la la-calendar"></i> &nbsp; <span> Officer </span></a>
									</li>
									<li>
									<a href="attendance_management.php"><i class="la la-calendar"></i> &nbsp; <span> Management </span></a>
									</li>
									
									<li><a href="Emp_Transfer.php"><i class="la la-calendar"></i> &nbsp; <span> Transfer </span> </a></li>
							...
							<!--<li class="submenu">
							 ...
							 <li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="salary-genrate.php"> Genrate Salary </a></li>
									<li><a href="allemp_salary.php" class=""> Employee Salary Report </a></li>
									<li><a href="pf.php"> Employee PF Details </a></li>
							 ...
							 <li class="submenu">
								...
								<ul style="display: none;">
									<li><a href="add_client.php"><i class="la la-map-marker"></i> &nbsp; <span> Add location (Site)</span></a></li>
									<li><a href="d_d.php"> <i class="la la-group"></i>  &nbsp; <span> Roles & Group  </span></a></li>
									<li><a href="salary-destribution.php"><i class="la la-money"></i> &nbsp; <span> Salary Settings </span></a></li>
									<li><a href="add_emply.php"><i class="la la-map-marker"></i> &nbsp; <span> Add Employees </span></a></li>
					   ...
					   <!-- <li> 
							...
							<li> 
								<a href="all_client.php"><i class="la la-user"></i> <span> All Client (Site) </span></a>
							</li>
							
							<li> 
								<a href="#"><i class="la la-book"></i> <span>Contacts</span></a>
							</li>
